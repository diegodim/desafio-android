...
class ContactsRepositoryImplTest {
    ...
    @Test
    fun `WHEN getContacts HAS success MUST be call localDataSource once and return a flow with result data`(): Unit = runBlocking {
    ...
    @Test
    fun `WHEN refreshContacts HAS success MUST be call remoteDataSource and insert on localDataSource`(): Unit = runBlocking {
    ...
    @Test
    fun `WHEN refreshContacts HAS failure MUST return a flow with failure exception`(): Unit = runBlocking {
